...
use App\Repository\StatutConventionRepository;
 ...
 * @ORM\Entity(repositoryClass=StatutConventionRepository::class)
 */
class StatutConvention
{
    /**
     * @Gedmo\Versioned
    ...
    /**
     * @ORM\OneToMany(targetEntity=Convention::class, mappedBy="statutConvention")
     */
    private $conventions;
    ...
    public function addConvention(Convention $convention): self
    {
        if (!$this->conventions->contains($convention)) {
            ...
            $convention->setStatutConvention($this);
        }
    ...
    public function removeConvention(Convention $convention): self
    {
        if ($this->conventions->removeElement($convention)) {
            ...
            if ($convention->getStatutConvention() === $this) {
                $convention->setStatutConvention(null);
            }
        }
