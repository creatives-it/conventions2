...
use App\Repository\NatureConventionRepository;
 ...
 * @ORM\Entity(repositoryClass=NatureConventionRepository::class)
 */
class NatureConvention
{
    /**
     * @Gedmo\Versioned
    ...
    /**
     * @ORM\OneToMany(targetEntity=Convention::class, mappedBy="natureConvention")
     */
    private $conventions;
    ...
    public function addConvention(Convention $convention): self
    {
        if (!$this->conventions->contains($convention)) {
            ...
            $convention->setNatureConvention($this);
        }
    ...
    public function removeConvention(Convention $convention): self
    {
        if ($this->conventions->removeElement($convention)) {
            ...
            if ($convention->getNatureConvention() === $this) {
                $convention->setNatureConvention(null);
            }
        }
