...
use App\Repository\StadeElaborationRepository;
 ...
 * @ORM\Entity(repositoryClass=StadeElaborationRepository::class)
 */
class StadeElaboration
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=Convention::class, mappedBy="stadeElaboration")
     */
    private $conventions;
    ...
    public function addConvention(Convention $convention): self
    {
        if (!$this->conventions->contains($convention)) {
            ...
            $convention->setStadeElaboration($this);
        }
    ...
    public function removeConvention(Convention $convention): self
    {
        if ($this->conventions->removeElement($convention)) {
            ...
            if ($convention->getStadeElaboration() === $this) {
                $convention->setStadeElaboration(null);
            }
        }
